...
UPSTREAM_STORE="${UPSTREAM_STORE:-https://cache.nixos.org}"
...
SC_MISC_REV="${SC_MISC_REV:-}"
SC_MISC_SHA256="${SC_MISC_SHA256:-}"
PERM_FDP_REV="${PERM_FDP_REV:-}"
PERM_FDP_SHA256="${PERM_FDP_SHA256:-}"
MAX_JOBS="${MAX_JOBS:-6}"
...
resolve_weekly_inputs() {
	...
	resolved_inputs="$(python3 "$DIR/resolve-weekly-inputs.py" \
		...
		--sc-misc-rev "$SC_MISC_REV" \
		--sc-misc-sha256 "$SC_MISC_SHA256" \
		--perm-fdp-rev "$PERM_FDP_REV" \
